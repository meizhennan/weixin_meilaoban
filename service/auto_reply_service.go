...
func searchDataAndCreateImg(msg string) (string, error) {
	...
	if err != nil {
		log.Printf("Delete file faild ,err :[%+v]", err)
		return "", err
	}
	xAxisOption := []string{
		"2016",
	...
	fileName = "income_from_operation_2.png"
	filePath2, err := helpers.DrawDoubleYaxis(stock, "营业利润趋势", xAxisOption, legendOption, seriesList, fileName)
	...
	fileName = "income_from_operation_3.png"
	filePath3, err := helpers.DrawDoubleYaxis(stock, "营业利润趋势", xAxisOption, legendOption, seriesList, fileName)
	...
	fileName = "income_from_operation_4.png"
	filePath4, err := helpers.DrawDoubleYaxis(stock, "营业利润趋势", xAxisOption, legendOption, seriesList, fileName)

	imagePaths := []string{filePath, filePath2, filePath3, filePath4}
